...
public class TensorOptionsScreen extends GameOptionsScreen
{
    ...
    protected void init()
    {
        ...
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 155 + 3 % 2 * 160, this.height / 6 - 12 + 24 * (3 >> 1), 150, 20, new TranslatableText("options.text"), (button) ->
        {
            this.client.setScreen(new TextFieldsScreen(this, this.gameOptions, new TranslatableText("options.text")));
        }));
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 155 + 4 % 2 * 160, this.height / 6 - 12 + 24 * (4 >> 1), 150, 20, new TranslatableText("options.dont_click"), (button) ->
        {
            this.client.setScreen(new DontClickOptionsScreen(this, this.gameOptions, new TranslatableText("options.dont_click")));
        }));
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 155 + 5 % 2 * 160, this.height / 6 - 12 + 24 * (5 >> 1), 150, 20, new TranslatableText("options.keybinds"), (button) ->
        {
            this.client.setScreen(new KeybindsScreen(this, this.gameOptions, new TranslatableText("options.keybinds")));
        }));
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 155 + 6 % 2 * 160, this.height / 6 - 12 + 24 * (6 >> 1), 150, 20, new TranslatableText("options.miscellaneous"), (button) ->
        {
