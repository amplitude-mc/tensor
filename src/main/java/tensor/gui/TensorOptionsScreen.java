...
public class TensorOptionsScreen extends GameOptionsScreen
{
    ...
    protected void init()
    {
        ...
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 155 + 1 % 2 * 160, this.height / 6 - 12 + 24 * (1 >> 1), 150, 20, Text.translatable("options.chat_emotes"), (button) ->
            this.client.setScreen(new ChatEmotesScreen(this, this.gameOptions, Text.translatable("options.chat_emotes")))));
        ...
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 155 + 7 % 2 * 160, this.height / 6 - 12 + 24 * (7 >> 1), 150, 20, Text.translatable("options.dont_click"), (button) ->
            this.client.setScreen(new DontClickOptionsScreen(this, this.gameOptions, Text.translatable("options.dont_click")))));
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 155 + 8 % 2 * 160, this.height / 6 - 12 + 24 * (8 >> 1), 150, 20, Text.translatable("options.keybinds"), (button) ->
            this.client.setScreen(new KeybindsScreen(this, this.gameOptions, Text.translatable("options.keybinds")))));
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 155 + 9 % 2 * 160, this.height / 6 - 12 + 24 * (9 >> 1), 150, 20, Text.translatable("options.miscellaneous"), (button) ->
